...
Item {
    ...
    Shape {
        ...
        ShapePath {
            strokeWidth: 4
            strokeColor: model.is_end ? (model.deadlock ? deadlock_color : end_node_color) : property_node_color
            startX: 0
    ...
    Rectangle {
        ...
        border.color: model.is_end ? (model.deadlock ? deadlock_color : end_node_color) : property_node_color
        border.width: 2
